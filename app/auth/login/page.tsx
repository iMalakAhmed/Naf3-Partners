...
export default function PartnerLoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f4f7f5] px-4 py-10 text-zinc-900 sm:px-6">
      <div className="mx-auto flex w-full max-w-4xl flex-col overflow-hidden rounded-[28px] border border-[#19BBB6]/20 bg-white shadow-[0_30px_90px_-50px_rgba(0,107,106,0.5)] lg:flex-row">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="mt-8 space-y-3 text-sm text-white/85">
              <div className="flex items-center gap-3">
                ...
                Track live points and balances.
              </div>
              <div className="flex items-center gap-3">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/20 text-xs">
                  02
                </span>
                Review partner transactions quickly.
              </div>
              <div className="flex items-center gap-3">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/20 text-xs">
                  03
                </span>
                Keep branch operations in sync.
              </div>
            </div>
          </div>
        </section>
